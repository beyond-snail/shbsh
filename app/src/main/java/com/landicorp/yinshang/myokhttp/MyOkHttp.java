package com.landicorp.yinshang.myokhttp;
...
import com.landicorp.yinshang.myokhttp.body.ProgressRequestBody;
import com.landicorp.yinshang.myokhttp.body.ResponseProgressBody;
import com.landicorp.yinshang.myokhttp.response.DownloadResponseHandler;
import com.landicorp.yinshang.myokhttp.response.GsonResponseHandler;
import com.landicorp.yinshang.myokhttp.response.IResponseHandler;
import com.landicorp.yinshang.myokhttp.response.JsonResponseHandler;
import com.landicorp.yinshang.myokhttp.response.RawResponseHandler;
...
public class MyOkHttp {
     ...
     * @param responseHandler 回调
     */
    public void postJsonLogin(Context context, final String url, String json, final IResponseHandler responseHandler, CallBackActivity callBackActivity) {
     ...
     * @param responseHandler 回调
     */
    public void postJson(Context context, final String url, String json, final IResponseHandler responseHandler, CallBackActivity callBackActivity, boolean isCallback) {
     ...
     * @param responseHandler 回调
     */
    public void postJsonHead(Context context, final String url, String json, String auth, final IResponseHandler responseHandler, CallBackActivity callBackActivity, boolean isCallback) {
                        ...
                        public void run() {
                            try {
                                ...
                                if (response_body == null){
                                    ...
                                    Gson gson = new Gson();
                                    JsonObject jo = gson.fromJson(response_body, JsonObject.class);
                                    try {
                                        String msg = "";
                                        try {
                                            msg = jo.get("msg").getAsString();
                                            mResponseHandler.onFailure(response.code(), msg);//, body=" + response_body);
                                        } catch (Exception e2) {
                                            mResponseHandler.onFailure(response.code(), "数据返回格式错误");//, body=" + response_body);
                                        }
                                    }catch (Exception e1){
