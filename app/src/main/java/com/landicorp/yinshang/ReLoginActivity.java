...
//        MyToast.showText(result.code+ "-----------" + result.result.sid);
        ...
        if(result != null && result.code.equals(Constant.SUCCESS_CODE)) {
            ...
            SharePreferenceHelper.getInstance(ReLoginActivity.this).putString("username", username);
            SharePreferenceHelper.getInstance(ReLoginActivity.this).putString("password", password);
